...
##################################################################################################
     ...
     ####################### Fill Keycode page details #########################################
            ...
            sleep 5
            onElement("ProdName","set","CP Automation","Keycode")
            onElement("ArthurSDesc","set","CP Automation","Keycode")
            onElement("WebProdName","set","CP","Keycode")
            onElement("ProdFeatures","set","CP","Keycode")            
            onElement("POSDesc","set","Sample","Keycode")
            onElement("SPLLine1","set","CP_product","Keycode")
